    ...
    return (
        <Container>
            <Row className='my-4 d-flex'>
                ...
                <Col>
                    <div className='d-flex align-items-center justify-content-center'>
                        <Button className='px-3'>GITHUB</Button>
                    </div>
                </Col>
            </Row>
            ...
            <div className='d-none d-lg-block'>
                <Card color='light' outline className='text-center d-flex flex-row w-75 mx-auto'>
                    <CardBody className='d-flex flex-column justify-content-evenly'>
                        ...
                        <div className='d-flex justify-content-evenly'>
                            <a href='https://github.com/DNA21/no-vig-odds' target='_blank'><span>Code <AiOutlineGithub /></span></a>
                            <a href='https://no-vig-odds.web.app/' target='_blank'><span>Live Demo <RxOpenInNewWindow /></span></a>
                        </div>
                    </CardBody>
            ...
            <div className='d-none d-lg-block'>
                <Card color='light' outline className='text-center d-flex flex-row w-75 mx-auto'>
                    ...
                    <CardBody className='d-flex flex-column justify-content-evenly'>
                        ...
                        <div className='d-flex justify-content-evenly'>
                            <a href='https://github.com/DNA21/no-vig-odds' target='_blank'><span>Code <AiOutlineGithub /></span></a>
                            <a href='https://cryptogecko-dg.web.app/' target='_blank'><span>Live Demo <RxOpenInNewWindow /></span></a>
                        </div>
                    </CardBody>
                </Card>
            </div>
            ...
            <div className='d-block d-lg-none'>
                <Card color='light' outline className='text-center w-75 mx-auto'>
                    <CardBody className='d-flex flex-column justify-content-evenly'>
                        <CardTitle>
                            <h3>No-Vig Odds</h3>
                        </CardTitle>
                        ...
                        <div className='d-flex justify-content-evenly'>
                            <span>Code <AiOutlineGithub /></span>
                            <span>Live Demo <RxOpenInNewWindow /></span>
                        </div>
                    </CardBody>
